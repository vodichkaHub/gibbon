...
echo_and_run cd "/home/vodichka/workspace/gibbon/catkin_ws/src/joint_state_publisher/joint_state_publisher"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/vodichka/workspace/gibbon/catkin_ws/src/joint_state_publisher/joint_state_publisher/setup.py" \
    egg_info --egg-base /home/vodichka/workspace/gibbon/catkin_ws/build/joint_state_publisher/joint_state_publisher \
    build --build-base "/home/vodichka/workspace/gibbon/catkin_ws/build/joint_state_publisher/joint_state_publisher" \
    install \
    --root="${DESTDIR-/}" \
